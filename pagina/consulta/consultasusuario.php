...
session_start();
  ...
  // Passando data do banco "AAAA-MM-DD" para "DD/MM/AAAA"   
    ...
    $id=$_SESSION['id'];
                            ...
                            inner JOIN atendimento att on att.id_atendimento_pet = p.id_pet where id='.$id.' 
                            ORDER by att.data';
                            foreach($dbh->query($sql)as $row)
                            {
                               ...
                               */
                                ...
                                echo ' ';
                                echo '
                                <a href="../../crud/agenda/editarconsultausuario.php?id_atendimento='.$row['id_atendimento'].'&data='.$row['data'].'&horario='.$row['horario'].'"
                                ...
                                echo ' ';
                                echo '
                                <a href="../../crud/agenda/atendeletarusuario.php?id_atendimento='.$row['id_atendimento'].'" 
