  ...
  echo'<div class="modal-dialog">';
     echo'<div class="modal-content">';
      echo'<form action="updateconsultaadm.php" method="POST">';
       echo'<div class="modal-header">     '; 
        echo'<h4 class="modal-title">Editar Consulta</h4>';
       ...
       echo'</div>';
        ...
        echo'<div class="form-group">';
         ...
         echo'<input type="date" class="form-control" name="data" value="'.$data.'"disabled >';
          ...
          echo'<input type="text" class="form-control" name="cpf" value="'.$cpf.'">';
            echo'</div>';

            echo'<div class="form-group " >';
            echo'<label>Nome do Mascote </label>';
          echo' <select class="form-control" id="id_pet" name="id_pet">';
             echo' <option value="">'.$nomepet.'/ Nome do Responsavel : '.$nome.'</option>';
      ...
      echo' <div class="control-group">
       ...
       echo'<button class="btn btn-default"><a href="../../pagina/consulta/consultas.php">Cancelar</a></button>';
